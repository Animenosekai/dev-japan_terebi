...
if(window.localStorage.getItem('vkAPIToken_accessToken') !== null){
    document.getElementById('accessTokenStatus').innerHTML = "Redirecting to the sources check page..."
    console.log('Successfull!')
    console.log("Redirecting...")
    window.open('/devtools/sources-check', '_self')
}else{
    document.getElementById('accessTokenStatus').innerHTML = "There was an error while getting the token"
